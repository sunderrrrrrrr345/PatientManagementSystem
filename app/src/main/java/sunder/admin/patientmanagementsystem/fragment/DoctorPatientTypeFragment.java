...
public class DoctorPatientTypeFragment extends Fragment  {
   ...
   private ImageView img_patient_upcoming,img_patient_visited,img_patient_list;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_doctor_patient_type, container, false);
        Hello(view);
        return view;
    }
    ...
    private void Hello(final View view) {
        ...
        img_patient_upcoming=view.findViewById(R.id.img_patient_upcoming);
        img_patient_list=view.findViewById(R.id.img_patient_list);
        img_patient_visited=view.findViewById(R.id.img_patient_visited);
        final AppCompatActivity activity = (AppCompatActivity) getActivity();
        activity.setSupportActionBar(toolbar);
        activity.getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        img_patient_upcoming.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ((PMSMainActivity)view.getContext()).viewPager.setCurrentItem(11);
            }
        });

        img_patient_list.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ((PMSMainActivity)view.getContext()).viewPager.setCurrentItem(4);
            }
        });

        img_patient_visited.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ((PMSMainActivity)view.getContext()).viewPager.setCurrentItem(7);
            }
        });
