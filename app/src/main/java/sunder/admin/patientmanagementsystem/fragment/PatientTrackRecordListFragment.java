...
public class PatientTrackRecordListFragment extends Fragment  {
   ...
   private TextView tv_serial_number,img_patient_exiting;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_patient_track_record_list, container, false);
        Hello(view);
        return view;
    }
    ...
    private void Hello(final View view) {
        ...
        tv_serial_number=view.findViewById(R.id.tv_serial_number);
       /* img_patient_exiting=view.findViewById(R.id.img_patient_exiting);*/
        final AppCompatActivity activity = (AppCompatActivity) getActivity();
        activity.setSupportActionBar(toolbar);
        activity.getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        tv_serial_number.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ((PMSMainActivity)view.getContext()).viewPager.setCurrentItem(6);
            }
        });

     /*   img_patient_exiting.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
