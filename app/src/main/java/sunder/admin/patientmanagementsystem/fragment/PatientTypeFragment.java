...
public class PatientTypeFragment extends Fragment  {
   ...
   private ImageView img_patient_new,img_patient_exiting,img_patient_list;
    ...
    private void Hello(final View view) {
        ...
        img_patient_new=view.findViewById(R.id.img_patient_new);
        ...
        img_patient_new.setOnClickListener(new View.OnClickListener() {
            @Override
